package com.pai.ClientSchema.utils;
...
/**
 * Tests for SchemaConversionUtils client app
 */

public class SchemaConversionUtilsTest {

    @Test
    public void toXMLGregorianCalendar() throws Exception {
        ...
        Assert.assertTrue(date.equals(SchemaConversionUtils.toXMLGregorianCalendar(date2)));
    }
    ...
    public void toSchemaType() throws Exception {
        ...
        com.pai.ClientSchema.Department dep_schema = new com.pai.ClientSchema.Department();
        dep_schema.setId(14);
        dep_schema.setName("test_department");

        com.pai.ClientSchema.Department dep_after_convertion = SchemaConversionUtils.toSchemaType(dep_model);
    ...
    public void toSchemaType1() throws Exception {
        ...
        com.pai.ClientSchema.Employee employee_schema = new com.pai.ClientSchema.Employee();
        ...
        com.pai.ClientSchema.Employee employee_after_convertion = SchemaConversionUtils.toSchemaType(employee_model);
